...
<body class="bg-slate-50">
    ...
    <div class="container p-10 mx-auto bg-white border rounded-lg shadow-md">
        <a href="<?php echo base_url('guru/inputGuru') ?>" class="px-4 py-2 font-medium uppercase bg-blue-400 rounded">Tambah Guru</a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url("guru/editGuru/") . $data->id_guru ?>" class="px-3 py-1 font-medium uppercase bg-yellow-400 rounded">Edit</a>
                            <a href="<?php echo base_url("guru/hapusGuru/") . $data->id_guru ?>" class="px-3 py-1 font-medium uppercase bg-red-500 rounded" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
