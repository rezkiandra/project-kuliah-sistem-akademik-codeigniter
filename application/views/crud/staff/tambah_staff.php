...
<body>
    <div class="flex flex-col items-center justify-center mx-auto bg-slate-50 h-5/6">
        <div class="p-5 bg-white border rounded-lg shadow-md">
            <h2 class="pb-3 text-2xl text-center border-b">Tambah Staff Baru</h2>
            <div class="my-3 w-96">
                <form action="<?php echo base_url('staff/tambahStaff') ?>" method="POST">
                    ...
                    <div class="flex flex-col mb-3">
                        ...
                        <input type="text" id="nama_staff" name="nama_staff" class="px-2 py-3 border rounded" required placeholder="Budi">
                    </div>
                    <div class="flex flex-col mb-3">
